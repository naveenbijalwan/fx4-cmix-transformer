...
def main() -> None:
    ...
    raw_model.load_state_dict(torch.load("models/6m-q4.tch"))
    ...
    warmup_epochs: int = 0
    epochs: int = 16
    warmup_learning_rate_multiplier: int = 1
    final_learning_rate_multiplier: float = 1e-8
    ...
    training_config = TrainingConfig(
        ...
        logger_config=LoggerConfig(
            wandb_project="fx2-cmix-transformer", wandb_run_name="cooldown"
        ),
    )
    ...
    if main_process:
        ...
        torch.save(raw_model.state_dict(), "models/6m-q4-fp32.tch")
